    ...
    {/* Contenedor de texto principal */}
      ...
      <div className="flex flex-col w-full max-w-[846px] items-center gap-8">
          <p className="use-system-font text-white font-light leading-1.56 xl:leading-[1.4] text-lg xl:text-xl text-center max-w-74 sm:max-w-144 xl:max-w-150 mx-auto">
            Soy desarrollador web especializado en crear sitios web modernos, rápidos y funcionales que impulsan tu presencia online.
          </p>
        
          <button
            className="h-10 bg-[#00B3B0] hover:bg-lime-300 text-black use-system-font font-semibold rounded-full flex items-center justify-center pl-4 pr-3 gap-1 transition-colors cursor-pointer"
          >
            Hablemos
